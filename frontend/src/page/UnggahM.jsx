...
import FooterU from "../component/footer2";
...
const UnggahM = () =>{
    ...
    return (
        <>
            <nav className="grid grid-cols-7 gap-4 items-center justify-items-center bg-[#fafafa] py-3">
                ...
                <div className="col-span-5">
                    <h1 className="text-[20px] font-[500]">Menambahkan Data</h1>
                </div>
                <div className="col-span-1 flex items-center">
