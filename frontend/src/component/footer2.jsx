...
import logo from '../Image/HUg.png';
...
const FooterU = () =>{
    ...
    return (
        <footer className='fixed bottom-0 w-full bg-white grid grid-cols-10 gap-9 items-center justify-items-center pt-6'>
            <div className="col-span-3 flex items-center">
                <a href="/Profile">
                <img src={logo} alt="" className='w-[45px] h-[45px] mr-1 hover:bg-white rounded-full'/>
                </a>
                <h1 className='font-bold text-[#92BB9B] text-[24px]'>Healthy<span className='text-[#323419] font-extrabold text-[26px]'>U</span></h1>
            </div>
